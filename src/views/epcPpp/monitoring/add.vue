        ...
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item label="所属区域" prop="monitorArea">
              <el-input v-model="form.monitorArea" />
            </el-form-item>
          </el-col>
          <el-col :md="12">
            <el-form-item label="通道号" prop="channel ">
              <el-input v-model="form.channel" class="form-input" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item label="首页显示" prop="homeFlag">
              <el-radio-group v-model="form.homeFlag">
  ...
  data() {
    ...
    return {
      ...
      formRules: {
        ...
        homeFlag: [{ required: true, message: '必填' }]
      },
