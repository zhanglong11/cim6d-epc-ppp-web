        ...
        <el-row>
          <el-col :span="12">
            <div class="formWrapper">
              ...
              <el-form-item label="详细表格" label-width="140px" prop="cashFlowFileIds">
                <Upload v-model="form.cashFlowFileIds" :accept="accept" isOnlyButton btnText="上传表格">
...
export default {
  ...
  data() {
    return {
      form: {},
      formRule: {
        cashFlowFileIds: [{ required: true, message: '必填', trigger: 'blur' }]
      },
      finishedStepsArr: [],
      tabIndex: '5',
      doingStepsArr: [],
