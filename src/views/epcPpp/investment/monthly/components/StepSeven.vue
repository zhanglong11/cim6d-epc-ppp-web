        ...
        <el-row>
          <el-col :span="12">
            <div class="formWrapper">
              <el-form-item label="项目公司名称" label-width="140px">
                <div>{{ companyName }}</div>
              </el-form-item>
              <el-form-item label="详细表格" label-width="140px" prop="legitimateProcedureFileIds">
                <Upload v-model="form.legitimateProcedureFileIds" :accept="accept" isOnlyButton btnText="上传表格">
...
export default {
  ...
  data() {
    return {
      form: {},
      formRule: {
        legitimateProcedureFileIds: [{ required: true, message: '必填', trigger: 'blur' }]
      },
      finishedStepsArr: [],
      tabIndex: '6',
      doingStepsArr: [],
